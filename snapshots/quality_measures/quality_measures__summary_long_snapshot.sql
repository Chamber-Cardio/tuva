...
{{
  config({
    ...
    , "unique_key": "unique_key": "person_id||coalesce(measure_id, '')||coalesce(measure_name, '')||coalesce(measure_version, '')||coalesce(cast(performance_period_begin as varchar), '')||coalesce(cast(performance_period_end as varchar), '')"
